...
#ifndef INCLUDED_USPSPackageSizeFinder_H
#define INCLUDED_USPSPackageSizeFinder_H
...
class USPSPackageSizeFinder{
public:
	//=
	//	returns "Regular", "Large", "Oversize", or "" (too big)
	//=
	static const char *getSize(Package *p);
};
