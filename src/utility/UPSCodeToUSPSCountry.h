...
#ifndef INCLUDED_UPSCodeToUSPSCountry_H
#define INCLUDED_UPSCodeToUSPSCountry_H

namespace rude{
namespace shipping{

class UPSCodeToUSPSCountry{
	static const char *themap[][2];
	
public:

	static const char *getUSPSCountry(const char *UPSCountryCode);
