// USPSDomesticCalculator.h: interface for the USPSDomesticCalculator class 
//
...
#ifndef INCLUDED_USPSDomesticCalculator_H
#define INCLUDED_USPSDomesticCalculator_H
...
public:
	//=
	// Creates USPSDomesticCalculator object
	//=
	USPSDomesticCalculator(const char *serveraddress, const char *userid, const char *password);
	
	//=
	// Destroys USPSDomesticCalculator object
	//=
	~USPSDomesticCalculator();
