// ItalyInternational3Day.h: interface for the ItalyInternational3Day class 
//
...
#ifndef INCLUDED_ItalyInternational3Day_H
#define INCLUDED_ItalyInternational3Day_H
...
class ItalyInternational3Day: public Service{


public:
	//=
	// Creates ItalyInternational3Day object
	//=
	ItalyInternational3Day();

	//=
	// Destroys ItalyInternational3Day object
	//=
	~ItalyInternational3Day();
