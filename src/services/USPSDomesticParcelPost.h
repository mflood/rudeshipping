// USPSDomesticParcelPost.h: interface for the USPSDomesticParcelPost class 
//
...
#ifndef INCLUDED_USPSDomesticParcelPost_H
#define INCLUDED_USPSDomesticParcelPost_H
...
class USPSDomesticParcelPost: public Service{


public:
	//=
	// Creates USPSDomesticParcelPost object
	//=
	USPSDomesticParcelPost();

	//=
	// Destroys USPSDomesticParcelPost object
	//=
	~USPSDomesticParcelPost();
