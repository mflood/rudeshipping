// USPSDomesticExpress.cpp: implementation for the USPSDomesticExpress class
//
...
USPSDomesticExpress::USPSDomesticExpress()
{
	setName("USPS Domestic Express");
}
...
bool USPSDomesticExpress::calculate(Package &p, Address &source, Address &dest)
{
	...
	if(!calculator.calculate(p, source, dest, "Express"))
	{
		setServiceCode(ERROR);
