// UPSGround.cpp: implementation for the UPSGround class
//
...
bool UPSGround::calculate(Package &p, Address &source, Address &dest)
{
	...
	if(!calculator.calculate(p, source, dest, "03"))
	{
		setServiceCode(ERROR);
