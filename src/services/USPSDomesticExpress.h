// USPSDomesticExpress.h: interface for the USPSDomesticExpress class 
//
...
#ifndef INCLUDED_USPSDomesticExpress_H
#define INCLUDED_USPSDomesticExpress_H
...
class USPSDomesticExpress: public Service{


public:
	//=
	// Creates USPSDomesticExpress object
	//=
	USPSDomesticExpress();

	//=
	// Destroys USPSDomesticExpress object
	//=
	~USPSDomesticExpress();
