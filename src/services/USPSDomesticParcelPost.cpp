// USPSDomesticParcelPost.cpp: implementation for the USPSDomesticParcelPost class
//
...
#include "USPSDomesticParcelPost.h"
...
USPSDomesticParcelPost::USPSDomesticParcelPost()
{
	setName("USPS Domestic Parcel Post");
}
...
bool USPSDomesticParcelPost::calculate(Package &p, Address &source, Address &dest)
{
	...
	if(!calculator.calculate(p, source, dest, "Parcel"))
	{
		setServiceCode(ERROR);
