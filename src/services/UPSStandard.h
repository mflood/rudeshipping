// UPSStandard.h: interface for the UPSStandard class 
//
...
#ifndef INCLUDED_UPSStandard_H
#define INCLUDED_UPSStandard_H
...
class UPSStandard: public Service{


public:
	//=
	// Creates UPSStandard object
	//=
	UPSStandard();

	//=
	// Destroys UPSStandard object
	//=
	~UPSStandard();
