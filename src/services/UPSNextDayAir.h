// UPSNextDayAir.h: interface for the UPSNextDayAir class 
//
...
#ifndef INCLUDED_UPSNextDayAir_H
#define INCLUDED_UPSNextDayAir_H
...
class UPSNextDayAir: public Service{


public:
	//=
	// Creates UPSNextDayAir object
	//=
	UPSNextDayAir();

	//=
	// Destroys UPSNextDayAir object
	//=
	~UPSNextDayAir();
