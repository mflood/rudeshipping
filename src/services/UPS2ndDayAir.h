// UPS2ndDayAir.h: interface for the UPS2ndDayAir class 
//
...
#ifndef INCLUDED_UPS2ndDayAir_H
#define INCLUDED_UPS2ndDayAir_H
...
class UPS2ndDayAir: public Service{


public:
	//=
	// Creates UPS2ndDayAir object
	//=
	UPS2ndDayAir();

	//=
	// Destroys UPS2ndDayAir object
	//=
	~UPS2ndDayAir();
