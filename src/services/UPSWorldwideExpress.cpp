// UPSWorldwideExpress.cpp: implementation for the UPSWorldwideExpress class
//
...
bool UPSWorldwideExpress::calculate(Package &p, Address &source, Address &dest)
{
	...
	if(!calculator.calculate(p, source, dest, "07"))
	{
		setServiceCode(ERROR);
