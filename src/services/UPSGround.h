// UPSGround.h: interface for the UPSGround class 
//
...
#ifndef INCLUDED_UPSGround_H
#define INCLUDED_UPSGround_H
...
class UPSGround: public Service{


public:
	//=
	// Creates UPSGround object
	//=
	UPSGround();

	//=
	// Destroys UPSGround object
	//=
	~UPSGround();
