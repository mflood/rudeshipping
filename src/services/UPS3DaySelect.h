// UPS3DaySelect.h: interface for the UPS3DaySelect class 
//
...
#ifndef INCLUDED_UPS3DaySelect_H
#define INCLUDED_UPS3DaySelect_H
...
class UPS3DaySelect: public Service{


public:
	//=
	// Creates UPS3DaySelect object
	//=
	UPS3DaySelect();

	//=
	// Destroys UPS3DaySelect object
	//=
	~UPS3DaySelect();
