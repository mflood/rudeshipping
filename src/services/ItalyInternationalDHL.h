// ItalyInternationalDHL.h: interface for the ItalyInternationalDHL class 
//
...
#ifndef INCLUDED_ItalyInternationalDHL_H
#define INCLUDED_ItalyInternationalDHL_H
...
class ItalyInternationalDHL: public Service{


public:
	//=
	// Creates ItalyInternationalDHL object
	//=
	ItalyInternationalDHL();

	//=
	// Destroys ItalyInternationalDHL object
	//=
	~ItalyInternationalDHL();
