// UPSStandard.cpp: implementation for the UPSStandard class
//
...
bool UPSStandard::calculate(Package &p, Address &source, Address &dest)
{
	...
	if(!calculator.calculate(p, source, dest, "11"))
	{
		setServiceCode(ERROR);
