// UPSWorldwideExpress.h: interface for the UPSWorldwideExpress class 
//
...
#ifndef INCLUDED_UPSWorldwideExpress_H
#define INCLUDED_UPSWorldwideExpress_H
...
class UPSWorldwideExpress: public Service{


public:
	//=
	// Creates UPSWorldwideExpress object
	//=
	UPSWorldwideExpress();

	//=
	// Destroys UPSWorldwideExpress object
	//=
	~UPSWorldwideExpress();
