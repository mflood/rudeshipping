// ItalyDomestic3Day.h: interface for the ItalyDomestic3Day class 
//
...
#ifndef INCLUDED_ItalyDomestic3Day_H
#define INCLUDED_ItalyDomestic3Day_H
...
class ItalyDomestic3Day: public Service{


public:
	//=
	// Creates ItalyDomestic3Day object
	//=
	ItalyDomestic3Day();

	//=
	// Destroys ItalyDomestic3Day object
	//=
	~ItalyDomestic3Day();
