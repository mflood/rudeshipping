// UPSNextDayAir.cpp: implementation for the UPSNextDayAir class
//
...
bool UPSNextDayAir::calculate(Package &p, Address &source, Address &dest)
{
	...
	if(!calculator.calculate(p, source, dest, "01"))
	{
		setServiceCode(ERROR);
