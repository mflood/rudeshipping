// USPSDomesticPriority.h: interface for the USPSDomesticPriority class 
//
...
#ifndef INCLUDED_USPSDomesticPriority_H
#define INCLUDED_USPSDomesticPriority_H
...
class USPSDomesticPriority: public Service{


public:
	//=
	// Creates USPSDomesticPriority object
	//=
	USPSDomesticPriority();

	//=
	// Destroys USPSDomesticPriority object
	//=
	~USPSDomesticPriority();
