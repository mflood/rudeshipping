// UPSExpressSaver.h: interface for the UPSExpressSaver class 
//
...
#ifndef INCLUDED_UPSExpressSaver_H
#define INCLUDED_UPSExpressSaver_H
...
class UPSExpressSaver: public Service{


public:
	//=
	// Creates UPSExpressSaver object
	//=
	UPSExpressSaver();

	//=
	// Destroys UPSExpressSaver object
	//=
	~UPSExpressSaver();
