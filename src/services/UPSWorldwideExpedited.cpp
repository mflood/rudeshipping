// UPSWorldwideExpedited.cpp: implementation for the UPSWorldwideExpedited class
//
...
#include "UPSWorldwideExpedited.h"
...
{
	setName("UPS Worldwide Expedited");
}
...
bool UPSWorldwideExpedited::calculate(Package &p, Address &source, Address &dest)
{
	...
	UPSCalculator calculator("www.ups.com", "9B9228BC4F095994", "myupsuserid", "myupspassword" );

	if(!calculator.calculate(p, source, dest, "08"))
	{
		setServiceCode(ERROR);
	...
	setPrice(calculator.getPrice() + 15.00);
